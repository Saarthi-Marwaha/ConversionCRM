...
/** "Continue with Google" — works for both sign-up and sign-in. */
export function GoogleAuthButton({ label = "Continue with Google" }: { label?: string }) {
  return (
    <form action={signInWithGoogle}>
      <button
        type="submit"
        className="w-full flex items-center justify-center gap-2.5 bg-white text-gray-700 font-semibold py-2.5 rounded-md text-sm shadow-soft ring-1 ring-gray-200 hover:bg-gray-50 transition-colors"
      >
